        ...
        <div style={{ maxWidth: 400, margin: "120px auto 0", padding: 24, background: "#fff", borderRadius: 8, boxShadow: "0 2px 8px rgba(0,0,0,0.1)" }}>
            ...
            <form>
                <div style={{ marginBottom: 16 }}>
                    <label>Họ tên</label>
                    <input type="text" required style={{ width: "100%", padding: 8, marginTop: 4 }} />
                </div>
                <div style={{ marginBottom: 16 }}>
                    <label>Email</label>
                ...
                <button type="submit" style={{ width: "100%", padding: 10, background: "#e53935", color: "#fff", border: "none", borderRadius: 4 }}>Đăng ký</button>
            </form>
        </div>
    );
}
